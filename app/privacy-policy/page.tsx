...
function Page() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 text-gray-800">
      ...
      <ul className="list-disc list-inside mb-4 space-y-1">
        <li><a href="https://www.google.com/policies/privacy/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Google Play Services</a></li>
        <li><a href="https://expo.io/privacy" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Expo</a></li>
      </ul>
      ...
      <p className="mb-4">
        The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider at <a href="mailto:fitnessevolution108@gmail.com" className="text-blue-600 hover:underline">fitnessevolution108@gmail.com</a> so that they will be able to take the necessary actions.
      </p>
      ...
      <p className="mb-4">
        This privacy policy is effective as of <strong>2025-04-20</strong>
      </p>
      ...
      <p className="mb-8">
        If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at <a href="mailto:fitnessevolution108@gmail.com" className="text-blue-600 hover:underline">fitnessevolution108@gmail.com</a>.
      </p>

      <hr className="border-t border-gray-300 mt-8" />
      {/* <p className="text-sm text-gray-500 mt-4">This privacy policy page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">App Privacy Policy Generator</a></p> */}
    </div>
  );
}
